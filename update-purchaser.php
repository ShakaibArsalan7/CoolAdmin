...
if(!$conn->connect_error){// if database connected.
    ...
    $id = (int)$_REQUEST['id'];
    $sql2 = "select * from purchaser where purchaser_id = $id";
                            ...
                            <div class="col-md-10">
                                <div class="card">
                                    <div class="card-header">
                                        Update <strong>Purchaser</strong> 
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="form-horizontal" onsubmit="return validateForm()">
                                            <div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label for="hf-username" class=" form-control-label">Purchaser Name</label>
                                                </div>
...
function validateForm() {
    ...
    if (username == "") {
    snackbar("Purchaser name is required.","red");
    return false;
    }
    if (emailaddress == "") {
