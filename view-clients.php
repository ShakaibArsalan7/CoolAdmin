...
<body class="animsition">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12" id="clienttable">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="largeModalLabel">Client Detail</h5>
    ...
    <script>
        ...
        function deleteclient() {
            ...
            var cid = parseInt($("#idval1").val());
            $('#confirmation').load("delajax.php", {
                cid: cid,
                fform: "clientdelete"
            }, function() {
                //load again
                $('#clienttable').load("delajax.php", {
                    fform: "loadclienttable"
                }, function() {
                    $('#example').DataTable({
                        "scrollX": true
                    });
