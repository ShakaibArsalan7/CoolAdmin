...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12" id="nutrienttable">
            ...
            <form action="update-nutrient.php" method="POST"><button type="submit" name="edit" style="margin:3px" value="edit" class="btn btn-success"><i class="fas fa-edit"></i></button>
                </form>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        <strong>Are you sure you want to delete this Nutrient ?</strong>
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="deletenutrient()">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function deletenutrient() {
            ...
            var nid = parseInt($("#idval1").val());
            $('#confirmation').load("delajax.php", {
                nid: nid,
                fform: "nutrientdelete"
            }, function() {
                //load again
                $('#nutrienttable').load("delajax.php", {
                    fform: "loadnutrienttable"
                }, function() {
                    $('#example').DataTable({
                        "scrollX": true
                    });
