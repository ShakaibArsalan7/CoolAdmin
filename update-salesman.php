...
if(!$conn->connect_error){// if database connected.
    ...
    //validation passed
        ...
        $sql7 = "update salesman set user_name = '$username' ,email_address='$emailaddress',work_phone='$workphone',mobile_number='$mobilenumber',work_address='$workaddress',home_address='$homeaddress',bank_account_title='$bankaccounttitle',bank_account_number='$bankaccountnumber',bank_name='$bankname',profile_pic='' where salesman_id = $id";
        
        $res = $conn->query($sql7);
       if($res){
           // updated , go to view page.
           header("Location: ./view-salesmen.php");
    ...
    $id = (int)$_REQUEST['id'];
    $sql2 = "select * from salesman where salesman_id = $id";
